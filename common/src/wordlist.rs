...
/// The constituents of code phrases. This word list is from
...
mod test {
    ...
    #[test]
    fn verify_wordlist() {
        assert_eq!(WORDLIST_LEN, WORDLIST.len(), "invalid word list length");
        assert_eq!(
            HashSet::from(WORDLIST).len(),
            WORDLIST.len(),
